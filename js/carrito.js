...
// mensaje post confirmación de compra completando form.
...
const mensaje = () => {
    ...
    carritoHTML.innerHTML = "";
    let datosEnvio = `<div class="datosEnvios">${nombreCliente} gracias por comprar con Back&Forth FC. En unos minutos
    ...
    if (nombreCliente.length === 0) {
        ...
        carritoHTML.innerHTML = "";
        let datosEnvio = `<div class="datosEnvios">Por favor, volvé a ingresar los datos en el formulario.</div>`
        carritoHTML.innerHTML = datosEnvio;
    } else {
        Swal.fire(
